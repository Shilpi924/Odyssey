...
export default function LicensesPage() {
  return (
    <LegalPage title="Software & License Notices" description="Odyssey’s code terms do not replace the licenses of its dependencies, data, or earlier releases.">
      ...
      <section><h2>Data licenses</h2><p>OpenStreetMap data is licensed separately under ODbL 1.0. National Park Service and California State Parks materials must be evaluated per item because official pages may include copyrighted or third-party content. See Data Sources for direct links and attribution.</p></section>
    </LegalPage>
  );
}
