...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Use" description="The conditions for using this early-stage trail discovery and local GPS tool.">
      ...
      <section><h2>Coverage and recommendations</h2><p>Officially sourced catalog coverage currently includes Yosemite National Park and Mount Diablo State Park. Outside that catalog, Odyssey may show community-mapped OpenStreetMap hiking routes and named paths. Rankings and filters help organize sourced records; they do not guarantee suitability, safety, accessibility, or availability for a particular person or group. Unknown or unavailable facts are intentionally left unknown rather than estimated.</p></section>
      <section><h2>Accounts, age, and saved information</h2><p>Some account and preference functions require third-party authentication. Odyssey is a general-audience service and is not directed to children under 13. A person under 13 must not create an account or submit personal information. Saved trails and active GPS records are stored locally in the browser unless a future feature clearly asks for permission to upload them. You are responsible for access to your device and account.</p></section>
