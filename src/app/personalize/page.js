        ...
        <div className="mt-12 bg-slate-800/80 rounded-2xl p-6 border border-slate-700 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {session?.user ? (
            <div className="flex flex-wrap justify-center gap-2 sm:justify-end">
              <Link href="/account-deletion" className="rounded-lg border border-rose-500/40 px-4 py-2 text-sm text-rose-200 transition-colors hover:bg-rose-950/40">Delete account data</Link>
