...
export default function Home() {
  return (
    <main className="min-h-screen bg-[var(--app-bg)] text-[var(--app-text)] overflow-hidden pb-24 transition-colors duration-300">
      <div className="absolute inset-x-0 top-0 h-[720px] bg-[radial-gradient(circle_at_78%_20%,var(--app-glow),transparent_34%),radial-gradient(circle_at_15%_15%,color-mix(in_srgb,var(--app-accent)_10%,transparent),transparent_28%)] pointer-events-none" />
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 py-24">
        <div className="grid lg:grid-cols-[.75fr_1.25fr] gap-12">
          <div><p className="text-xs uppercase tracking-[.2em] text-[var(--app-accent)]">Why Odyssey</p><h2 className="mt-4 text-3xl sm:text-4xl font-semibold tracking-tight">Less searching.<br />More confidence.</h2></div>
