...
export default function PlanPage() {
  ...
  return (
    <main className="min-h-screen bg-[#07130f] text-[#f5f2e8] pb-24">
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 pt-10 sm:pt-16">
        <div className="mb-10">
          <p className="text-xs uppercase tracking-[.2em] text-emerald-300">Plan a hike</p>
        ...
        <section className="rounded-3xl border border-white/10 bg-[#0d1d17] p-6 sm:p-10 shadow-2xl min-h-[440px]">
